...
|**Duplicate PA when the original PA is already decisioned** </li><li>PA submitted on the same date as a PA already decisioned (approved, denied, not required, cancelled, approved) for the same drug, dose & frequency  </li><li>**See below for the process when the original PA is awaiting decision** | Follow proper cancellation procedure, using the "Duplicate Request" Fax Template |
