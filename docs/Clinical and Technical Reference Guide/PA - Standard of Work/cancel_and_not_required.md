...
|**Duplicate PA when the original PA is in the following status (Med Review, Approved, In Process)** </li><li>PA submitted on the same date as a PA already approved or in Med Review for the same drug, dose & frequency  </li><li>**See below for the process when the original PA is awaiting decision** | Follow proper cancellation procedure, using the "Duplicate Request" Fax Template |
...
| **Duplicate PA when the original PA is in the following status (Pending)** <ul><li>Note: When the original PA was decisioned Denied or Not Required, follow normal PA processes. No need to send a fax back as one of the PAs will be decisioned and a fax sent then  |  PA submitted on the same date as a PA awaiting decision for the same drug, dose & frequency <ul><li>Check work manger and Teams message the Tech or RPh with PA allocated to them. Review the approved question set: [Duplicate PAs Awaiting Decision Question Set](https://mygainwell-my.sharepoint.com/:w:/g/personal/emily_reinhart_gainwelltechnologies_com/ETp20tRy96lLhXAiwrBaSqMB48u1XsbxrkAUt5EhhDAcuQ?e=uJDdNi){:target="_blank" rel="noopener"} </li></ol><li>Determine if one PA will be cancelled and one decisioned or if both PAs will be decisioned, following the guidance in the "Duplicate PAs Awaiting Decision Question Set"  </li><li>**If both PAs will be decisioned:**  </li><ol><li>Notate the Auth ID of the corresponding PA to be decisioned along with explanation for decisioning both  <ul></ol><li>**If one PA is decisioned and the other cancelled:** </li><ol><ol><li>**In the PA notes for the PA to be decisioned:** Notate the Auth ID of the PA that will be cancelled and an explanation for cancellation  </li><ol></ol><li>**In the PA notes for the PA to be cancelled:** Notate the Auth ID of the PA that will be decisioned and an explanation for cancellation.  | 
