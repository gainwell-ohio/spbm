...
<td></td>
<td>Free Text</td>
<td>Prior Authorization for a preferred short-acting opioid is only required if the initial request (defined as no opioids in the previous 90 days) exceeds 30 MED AND/OR exceeds a 7 days supply (or 5 days supply if &lt;18 years old).</td>
<td>END (Pending Manual Review) </td>
<td></td>
</tr>
</tbody>
